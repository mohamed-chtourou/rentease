            ...
            <div className="footer-content">
                <div className="footer-section">
                    ...
                    <p className="footer-description">
                        Find your perfect home with ease. Whether you're looking to rent a room or an entire property, we make it simple.
                    </p>
                    <div className="footer-social">
                        {/* External social links should point to real URLs; placeholders replaced */}
